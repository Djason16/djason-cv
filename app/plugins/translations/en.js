export default {
    ...
    adminSection1Content: "This administration area allows you to manage your entire freelance business: clients, projects, quotes, invoices, and contracts from a centralized and secure interface.",
    adminSection2Title: "Complete business management",
    adminSection2Content: "Track your ongoing projects, generate custom quotes, issue professional invoices, and archive your contracts. All your data is synchronized in real time.",
    adminSection3Title: "Security and privacy",
    adminSection3Content: "Your session is protected by secure authentication. All data is encrypted and automatically backed up. Remember to log out after use to ensure the security of your information.",
    adminSection4Title: "Analytics and performance",
    adminSection4Content: "View your detailed statistics: monthly revenue, completed projects, pending invoices, and conversion rates. Identify growth opportunities and optimize your profitability with customizable visual reports.",
    logoutButton: "Logout",
