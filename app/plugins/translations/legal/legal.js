export default {
    french: {
        ...
        legalSection2Content: "Le site est hébergé par Infomaniak Network SA, dont le siège est situé au 26 rue Eugène-Marziano, 1227 Genève, Suisse. Leur numéro de téléphone est le +41 22 820 35 44. Leur site web : [www.infomaniak.com](https://www.infomaniak.com).",
    ...
    english: {
        ...
        legalIntro: "The mandatory information about this website, in accordance with the French law for confidence in the digital economy of June 21, 2004.",
        legalSection1Title: "1. Who publishes this site?",
        legalSection1Content: "This website is published by {{name}}, sole proprietor. SIRET: {{siret}}. VAT not applicable – Article 293 B of the French Tax Code. Address: {{address}}. You can contact me by email at {{email}} or by phone at {{phone}}.",
        legalSection2Title: "2. Where is the site hosted?",
        legalSection2Content: "The site is hosted by Infomaniak Network SA, headquartered at 26 rue Eugène-Marziano, 1227 Geneva, Switzerland. Their phone number is +41 22 820 35 44. Their website: [www.infomaniak.com](https://www.infomaniak.com).",
        legalSection3Title: "3. Intellectual Property",
        legalSection3Content: "All elements on this site (texts, images, videos, source code, software architectures, logos) are protected by French intellectual property law and remain the exclusive property of the publisher. You may not reproduce, modify, or distribute them without my written authorization. Any infringement or code extraction may lead to criminal penalties under Articles L.335-2 and following of the same Code.",
        legalSection4Title: "4. Publishing Director",
        legalSection4Content: "The publishing director of this site is {{name}}. For any question, contact me at {{email}}.",
        ...
        legalSection8Content: "This site and its terms of use are governed by French law. In the event of a dispute arising from the use of this site or the interpretation of these notices, and failing an amicable solution, exclusive jurisdiction is granted to the competent courts of the publisher's registered office."
    }
}