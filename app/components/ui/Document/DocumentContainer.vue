    ...
    <div class="document-container">
        <div class="content">
            ...
            <DocumentHeader :issueDate="issueDate" :documentNumber="documentNumber"
                ...
                :companyWebsite="companyWebsite" :companyAddress="companyAddress" :companySiret="companySiret"
                :hasTVA="hasTVA" :companyTvaNumber="companyTvaNumber" :companyPhone="companyPhone"
            ...
            <BankInfo v-if="bankInfo" :bankInfo="bankInfo" />
            <QuoteSignature v-if="isQuoteType" />
            <CompanySignature :signerName="signerName" />
        </div>
    </div>
</template>
...
const { invoiceAddress: companyAddress, siret: companySiret, tvaNumber: companyTvaNumber,
    phone: companyPhone, email: companyEmail, name: signerName, bank: bankInfo } = personalInfo
